...
function beginLife(){
  ...
  G.medCareer = {
    active:false,
    stage:'none',               // none|med_student|junior_doctor|specialist_training|consultant
    yearsInStage:0,
    specialty:'general_practice', // surgery|psychiatry|general_practice
    ...
    patientHistory:[],
    activeCase:null,
    flags:{ fired:false, suspended:false, boardWarning:false },
  };
  G.acting = {
